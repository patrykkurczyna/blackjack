...
public class BlackjackServer {
	...
	private static final Logger logger = Logger
			.getLogger(BlackjackServer.class);
	 ...
	 * System.getProperty("java.rmi.server.hostname"); private static final int
	 * PORT = Integer.parseInt(System.getProperty("java.rmi.server.port"));
	 * private static final String RMI_REGISTRY_ADDRESS = "rmi://" + HOSTNAME +
	 * ":" + PORT; private static final String BLACKJACK_REMOTE_OBJECT_NAME =
	 * "blackjack";
	 */
	...
	public static void main(String[] args) {
		...
		try {
			...
			// -
			// Registry createRegistry = LocateRegistry.getRegistry(HOSTNAME,
			// PORT);
			...
			Naming.rebind(RMI_REGISTRY_ADDRESS + "/"
					+ BLACKJACK_REMOTE_OBJECT_NAME, blackjack);
